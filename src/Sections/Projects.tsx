      ...
      <div className="container">
        ...
        <div className="grid-container">
          <div className="project-container">
            ...
            <a href="https://github.com/brandonjmarquez/piano-roll" target="_blank">Github</a>
          </div>
          ...
          <div className="project-container">
            ...
            <a href="https://github.com/brandonjmarquez/Website" target="_blank">Github</a>
          </div>
          ...
          <div className="project-container">
            ...
            <a href="https://github.com/brandonjmarquez/car-dealership">Github</a>
          </div>
